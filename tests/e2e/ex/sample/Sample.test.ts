...
test("Text typing basics", async t => {
  await t
    .typeText(page.nameInput, "Saglac") // Type name
    .typeText(page.nameInput, "Salac.IO", { replace: true }) // Replace with last name
    .typeText(page.nameInput, "g", { caretPos: 2 }) // Correct last name
    .expect(page.nameInput.value)
    .eql("Saglac.IO"); // Check result
});
